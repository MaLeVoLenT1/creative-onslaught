    ...
    export default {
        ...
        computed:{
            showDisplay:function(){
                if(this.isFloating && !this.isMoved) return true;
                else return false;
            }
        },
        mounted(){
            ...
            switch(this.headerStyle){
                case'floating': this.isOverlay = true; this.isFloating = true; this.isCenter = false; this.isContainer = false; this.isFluid = false; break;
                case'standard': this.isOverlay = false; this.isFloating = false; this.isCenter = false; this.isFluid = true; this.isContainer = false; break;
                case'center': this.isOverlay = false; this.isFloating = false; this.isCenter = true; this.isFluid = true; this.isContainer = false; break;
                case'fixed': this.isOverlay = true; this.isFloating = false; this.isCenter = false; this.isFluid = true; this.isContainer = false; break;
            }
